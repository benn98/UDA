...
<body class="stretched">
    ...
    <section id="content">
        ...
        <div class="container clearfix">
                            ...
                            <h3>Qui puoi modificare, eliminare ed aggiungere eventi,categorie,artisti</h3>
                        </div>
            <div class="row clearfix">
                <div class="col-md-4 center">
                    <a href="<c:url value="/list?type=eventi"/>" class="button button-circle">Eventi</a>
                </div>
                <div class="col-md-4 center">
                    <a href="<c:url value="/list?type=categorie"/>" class="button button-circle">Categorie</a>
                </div>
                <div class="col-md-4 center">
                    <a href="<c:url value="/list?type=artisti"/>" class="button button-circle">Artisti</a>
                </div>
            </div>
        </div>
                </br>
                ...
                <div class="container clearfix">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Lista Utenti iscritti a Glycen</div>
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <c:forEach items="${utentiList}" var="utentiList">
                                    <tr>
                                <th>${utentiList.username}</th>
                                <th>${utentiList.nome}</th>
                                <th>${utentiList.cognome}</th>
                                <th>${utentiList.email}</th>
                                    </tr>
                                </c:forEach>
                            </table>
                        </div>
