...
============================================= -->
    <div id="wrapper" class="clearfix">
		...
		<div class="container clearfix">
                    <div class="col_half"><h3>Clicca sul pulsante a fianco per vedere tutta la storia dei nostri eventi</h3></div>
                    <div class="col_half col_last"><a href="<c:url value="/eventStory"/>" class="button button-circle">Story</a></div>
                    <!-- Posts
                    =============================================-->
                   <div id="posts" class="events small-thumbs">
                            ...
                            <c:forEach items="${eventi}" var="eventi">           
                                <div <c:choose>
                                    ...
                                    <div class="entry clearfix" style="max-height:548px;">
